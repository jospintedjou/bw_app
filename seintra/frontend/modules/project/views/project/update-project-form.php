...
<div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <?php $form = ActiveForm::begin(['action' => Url::toRoute('project/update-project'), 'id'=>'projectUpdate']); ?>    
            <div class="modal-body">
               ...
               <div class='row'>
                ...
                echo    $form->field($model, 'devs')
                        ...
                        'name'=>'from[]',
//                        'onchange' => 'var $options = ""; '
//                                    . '$("#projectUpdate #devsId2 option:selected").each(function(){'
               ...
               ?>
                ...
                <?= $form->field($model, 'chief')
                         ->dropDownList([],['id'=>'chiefId'] )
                             ->label('Chef de projet', ['style5' =>['position'=>'relative', 'left'=>'-40%']]); ?>
                </div>
                <?php } ?> 
                <?= $form->field($model, 'dateStart2')->widget(DatePicker::className(),
                                            ...
                                            ->label('date de début') ?>
                <?= $form->field($model, 'dateEnd2')->widget(DatePicker::className(),['pluginOptions' => [
                                'autoclose'=>true,
                                'language'=>'en',
                                'format' => 'yyyy-mm-dd',
                                'startDate' => "0d",
