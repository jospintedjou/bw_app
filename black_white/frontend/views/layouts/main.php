...
//          $menuItems[] = ['label' => 'Signup', 'url' => ['/site/signup']];
                ...
                $menuItems[] = ['label' => 'Tack Order', 'url' => ['/order/order/order-entry'], 'options' => ['class' => 'hidden-lg']];
                $menuItems[] = ['label' => 'Accept Orders', 'url' => ['/order/accept-order/accept-serv-order'], 'options' => ['class' => 'hidden-md hidden-xs hidden-sm']];
                $menuItems[] = '<li>'
...
//            $menuItems[] = ['label' => '<div class="row"><div class="col-md-6" style"display:inline-block"><img src="../../backend/web/uploads/' . $picture . '"id="ProfImg" class="img-circle profile_img" style="width:90%; height:4em; margin:2px" /></div><div class="col-md-6" style="display:inline-block; line-height: 20px"> Bienvenu  ' . Yii::$app->user->identity->prenom . '</div></div>', 'url' => '#', 'options' => ['style' => 'padding:0px; margin: 0px ', 'id' => 'firstLi']];
            }
...
//            }
//            if ((Yii::$app->user->identity->role == 'DG') || (Yii::$app->user->identity->role == 'DT')) {
...
//            ];
            ...
            //  if (!Yii::$app->user->isGuest) {
            NavBar::begin([
                // 'brandLabel' => 'Black&White',
                // 'brandUrl' => Yii::$app->homeUrl,
                'options' => ['class' => ' navbar-fixed-top navbar-inverse'],
            ]);
         ...
         <div>
            <footer class="navbar navbar-default navbar-fixed-bottom" style="margin: 0px;" >

                <p class="pull-left">&copy; Black&White <?= date('Y') ?></p>
